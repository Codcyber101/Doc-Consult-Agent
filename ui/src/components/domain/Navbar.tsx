...
export function Navbar({ user }: NavbarProps) {
  ...
  return (
    <nav className="sticky top-0 z-50 w-full bg-white/80 backdrop-blur-glass border-b border-slate-200">
        ...
        <div className="flex justify-between items-center h-16 md:h-20">
          ...
          <div className="flex items-center gap-3">
            <Link href="/" className="flex items-center gap-3 group">
              <div className="relative w-10 h-10 bg-gradient-emerald rounded-xl flex items-center justify-center shadow-lg shadow-emerald-200/50 group-hover:shadow-emerald-200/80 transition-shadow">
          ...
          <div className="hidden md:flex items-center gap-8">
             <Link href="/services" className="text-sm font-medium text-slate-600 hover:text-emerald-700 transition-colors">
               Services
             </Link>
             <Link href="/track" className="text-sm font-medium text-slate-600 hover:text-emerald-700 transition-colors">
               Track Application
             </Link>
             <Link href="/vault" className="text-sm font-medium text-slate-600 hover:text-emerald-700 transition-colors">
               Document Vault
             </Link>
          </div>
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <Button variant="ghost" size="icon" className="text-slate-500 hover:text-emerald-600 relative">
            ...
            {user ? (
               ...
               <Button className="bg-slate-900 text-white hover:bg-emerald-700">
                 Sign In
               </Button>
            )}
          </div>
