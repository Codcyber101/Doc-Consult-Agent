    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div className="bg-surface w-full max-w-2xl rounded-2xl shadow-2xl pointer-events-auto flex flex-col max-h-[85vh] overflow-hidden border border-border">
              {/* Header */}
              <div className="p-6 border-b border-border flex items-center justify-between bg-surface-muted/60">
