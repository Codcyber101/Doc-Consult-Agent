  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-950 flex flex-col">
      ...
      <header className="h-20 bg-slate-900 border-b border-slate-800 flex items-center justify-between px-8">
        ...
        <div className="flex items-center space-x-4">
          <button 
            ...
            className="flex items-center space-x-2 px-6 py-2.5 bg-slate-800 text-slate-200 rounded-xl font-bold hover:bg-slate-700 transition-all border border-slate-700"
          >
            <Play size={18} />
          ...
          <button 
            ...
            className="flex items-center space-x-2 px-8 py-2.5 bg-primary text-white rounded-xl font-bold hover:bg-primary-dark shadow-lg shadow-blue-900/40 transition-all"
          >
            <Save size={18} />
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-1 bg-slate-950 p-8 font-mono text-slate-300 text-sm leading-relaxed overflow-auto">
          <textarea 
        ...
        <div className="w-96 bg-slate-900 border-l border-slate-800 p-8 space-y-8 overflow-auto">
          <div>
          ...
          <div>
            ...
            <div className="space-y-3">
              {['Compliant with Proc. 1205/2020', 'Linked to MESOB-API-v2'].map((dep, i) => (
                <div key={i} className="flex items-center space-x-3 text-slate-300 bg-slate-800/60 p-3 rounded-xl text-xs font-medium">
          ...
          {isTesting && (
            <div className="animate-in slide-in-from-right duration-300">
              ...
              <div className="bg-slate-950 rounded-2xl p-4 space-y-4 border border-slate-800 shadow-xl">
