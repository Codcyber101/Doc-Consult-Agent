...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({
    ...
    const variants = {
      ...
      // Secondary Accent
      secondary: cn(
        "bg-surface-muted dark:bg-slate-800 text-slate-900 dark:text-white",
        "hover:bg-surface-muted dark:hover:bg-slate-700",
      ),

      // Outlined button
      outline: cn(
        "border-2 border-border dark:border-slate-800 bg-transparent text-slate-700 dark:text-slate-300",
      ...
      ghost: cn(
        ...
        "hover:bg-surface-muted dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white"
      ),
