      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <h1 className="text-3xl font-display font-bold text-slate-900 tracking-tight">
            Policy <span className="text-emerald-600 italic">Registry Canvas</span>
          </h1>
        ...
        <div className="xl:col-span-4 space-y-6">
           <div className="relative">
              ...
              <input 
                ...
                className="w-full h-11 pl-10 pr-4 bg-white border border-slate-200 rounded-xl text-sm outline-none focus:border-emerald-500 shadow-sm"
              />
           </div>
              ...
              {POLICIES.map((policy) => (
                ...
                >
                   ...
                   <div className="flex items-center justify-between text-[10px] font-bold uppercase tracking-widest text-slate-400">
                      ...
                      <span className="text-emerald-600">{policy.status}</span>
                   </div>
                </div>
              ))}
           </div>
        ...
        <div className="xl:col-span-8">
           <AnimatePresence mode="wait">
              <motion.div
                ...
                className="bg-white rounded-[3rem] border border-slate-100 shadow-xl overflow-hidden flex flex-col h-[700px]"
              >
                 {/* Toolbar */}
                 <div className="p-6 border-b border-slate-50 bg-slate-50/50 flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                       <Button variant="outline" size="sm" className="rounded-xl border-slate-200 text-xs font-bold gap-2">
                          <History className="w-4 h-4" /> Diff
                       </Button>
                       <Button variant="outline" size="sm" className="rounded-xl border-slate-200 text-xs font-bold gap-2">
                          <Play className="w-4 h-4" /> Test
                       </Button>
                       <Button size="sm" className="bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl text-xs font-bold gap-2 shadow-glow-emerald px-6">
                 ...
                 <div className="flex-1 flex bg-slate-900">
                    ...
                    <div className="flex-1 p-6 font-mono text-sm text-emerald-400 leading-6 overflow-y-auto">
