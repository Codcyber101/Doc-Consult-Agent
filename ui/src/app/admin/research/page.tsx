    ...
    <div className="space-y-10 pb-20">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
        <div>
          ...
          <h1 className="text-4xl font-display font-bold text-slate-900 tracking-tight">Research <span className="text-primary italic">Lab</span></h1>
        ...
        <div className="flex items-center gap-3 bg-primary/10 px-4 py-2 rounded-xl border border-primary/20">
           ...
           <span className="text-xs font-bold text-primary uppercase tracking-widest">Compute: Optimal</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-4 space-y-6">
          <Card className="rounded-[2.5rem] border-border shadow-xl overflow-hidden relative">
            <CardHeader className="bg-surface border-b border-border p-8">
               <div className="flex items-center gap-4">
                 <div className="w-12 h-12 bg-surface rounded-2xl flex items-center justify-center text-slate-900 shadow-sm border border-border">
                   <Archive size={24} />
                 </div>
            ...
            <CardContent className="p-8 space-y-8">
              <div className="space-y-3">
                ...
                <div className="relative group">
                  ...
                  <input 
                    ...
                    className="w-full h-12 pl-12 pr-4 bg-surface border border-border rounded-xl font-bold text-sm outline-none focus:border-primary shadow-sm transition-all"
                  />
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="grid gap-2">
                  {['moti.gov.et', 'eic.gov.et', 'chilot.me'].map((domain) => (
                    <label key={domain} className="flex items-center justify-between p-4 bg-surface rounded-xl cursor-pointer border border-transparent hover:border-primary/20 transition-all">
              ...
              <Button 
                ...
                className="w-full h-14 bg-slate-900 hover:bg-primary-dark text-white rounded-2xl font-bold gap-3 shadow-xl transition-all group"
              >
              ...
              <AnimatePresence>
                {isCrawlActive && (
                  <motion.div 
                    ...
                    className="flex items-center gap-3 px-4 py-2 bg-primary/20 rounded-full border border-primary/30"
                  >
            ...
            <div className="flex-1 p-12 font-mono text-sm space-y-6 overflow-auto custom-scrollbar relative z-10">
              {!isCrawlActive ? (
                ...
                <div className="space-y-4">
                  ...
                  <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 2 }} className="text-primary font-bold">[V-ID] MATCH FOUND: Proc_1321.pdf (0x82f...)</motion.div>
