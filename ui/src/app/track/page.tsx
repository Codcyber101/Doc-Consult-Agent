              ...
              {APPLICATIONS.map((app, i) => (
                ...
                >
                   <Card className={cn(
                     ...
                     app.urgent ? "border-red-100 hover:border-red-200" : "border-border hover:border-primary/20"
                   )}>
           ...
           <div className="lg:col-span-4 space-y-8">
              <Card className="bg-slate-900 text-white border-none overflow-hidden relative">
                 <CardContent className="p-8">
                    <div className="w-12 h-12 bg-primary rounded-2xl flex items-center justify-center mb-6 shadow-glow-primary">
