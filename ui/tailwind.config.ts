  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        // Glow shadows
        'glow-primary': '0 0 20px rgba(0, 107, 63, 0.15)',
        'glow-primary-lg': '0 0 40px rgba(0, 107, 63, 0.2)',
        'glow-gold': '0 0 20px rgba(253, 184, 19, 0.2)',
        'glow-gold-lg': '0 0 40px rgba(253, 184, 19, 0.25)',
      },
      backgroundImage: {
        // Gradient utilities
        'gradient-primary': 'linear-gradient(135deg, #006B3F 0%, #10b981 100%)',
        'gradient-gold': 'linear-gradient(135deg, #FDB813 0%, #f59e0b 100%)',
        'gradient-radial': 'radial-gradient(var(--tw-gradient-stops))',
        'mesh-primary': `radial-gradient(at 40% 20%, hsla(156, 100%, 22%, 0.1) 0px, transparent 50%),
