...
from cost_control_agent.monitor import CostMonitor
from cost_control_agent.enforcer import BudgetEnforcer
...
def test_budget_enforcement(clean_cost_monitor):
    ...
    with patch("cost_control_agent.enforcer.cost_monitor", clean_cost_monitor):
        ...
        clean_cost_monitor.track_usage(
            "llama-3.1-70b-versatile", 1_000_000, 0, "session_A"
        )
        ...
        clean_cost_monitor.track_usage(
            "llama-3.1-70b-versatile", 1_000_000, 0, "session_B"
        )
        # Total cost now ~1.18
